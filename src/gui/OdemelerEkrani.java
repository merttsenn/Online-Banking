...
public class OdemelerEkrani implements IPanelAyar {
    ...
    public OdemelerEkrani() {
        ...
        getElektrikBorcuLabel().setText(Actions.getDataController().getElektrikFaturasi() + " TL");
        getSuBorcuLabel().setText(Actions.getDataController().getSuFaturasi() + " TL");
        getInternetBorcuLabel().setText(Actions.getDataController().getInternetFaturasi() + " TL");
        getDogalgazBorcuLabel().setText(Actions.getDataController().getDogalgazFaturasi() + " TL");
